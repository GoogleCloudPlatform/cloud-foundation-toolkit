...
../../../bin/cft blueprint metadata -d -p "$BLUPRINT_FOLDER/"

mkdir $GIT_FOLDER
cp "../$GOLDENS_FOLDER/$GOLDEN_METADATA" "../$WORKING_FOLDER/$GIT_FOLDER/$WORKING_METADATA"
cp "../$GOLDENS_FOLDER/$GOLDEN_DISPLAY_METADATA" "../$WORKING_FOLDER/$GIT_FOLDER/$WORKING_DISPLAY_METADATA"
