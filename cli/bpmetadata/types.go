...
type BlueprintInfo struct {
	...
	Title string
	// Solution source location and source type
	// Autogen details in BlueprintRepoDetail
	Source *BlueprintRepoDetail
	// Semantic version  for the packaged solution
	...
	// The cost estimate for the solution based on preconfigured variables.
	// Autogen details in BlueprintCostEstimate
	CostEstimate BlueprintCostEstimate `json:",omitempty" yaml:",omitempty"`
	// A list of GCP cloud products used in the solution.
	// Manually authored.
	...
	// Details on the author producing the solution.
	// Manually authored.
	Author BlueprintAuthor `json:",omitempty" yaml:",omitempty"`
	// Details on sotfware installed as part of the solution.
	// Manually authored.
	SoftwareGroups []BlueprintSoftwareGroup `json:",omitempty" yaml:",omitempty"`
	// Support offered, if any for the solution.
	// Manually authored.
...
// A time estimate in secs required for configuring the solution
...
// A GCP cloud product used in the solution.
// Manually authored.
type BlueprintCloudProduct struct {
	...
	// If this product is a key in determining the GCP regions/zones the solution
...
// A group of related software components for the solution
