...
type BlueprintUIOutput struct {
	...
	// A table of application-specific label/value pairs.
	// Gen: manually-authored
	ApplicationTable *ApplicationTable `protobuf:"bytes,4,opt,name=application_table,json=applicationTable,proto3" json:"applicationTable,omitempty" yaml:"applicationTable,omitempty"` // @gotags: json:"applicationTable,omitempty" yaml:"applicationTable,omitempty"
}
...
func (x *BlueprintUIOutput) GetApplicationTable() *ApplicationTable {
	if x != nil {
		return x.ApplicationTable
	}
	return nil
}

// A table of label value pairs. Child of [Runtime][].
type ApplicationTable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// An ordered list of label/value rows to show in the table.
	// Gen: manually-authored
	Rows []*ApplicationTable_Row `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty" yaml:"rows,omitempty"` // @gotags: json:"rows,omitempty" yaml:"rows,omitempty"
}

func (x *ApplicationTable) Reset() {
	*x = ApplicationTable{}
	if protoimpl.UnsafeEnabled {
...
func (x *ApplicationTable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApplicationTable) ProtoMessage() {}

func (x *ApplicationTable) ProtoReflect() protoreflect.Message {
	mi := &file_bpmetadata_ui_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApplicationTable.ProtoReflect.Descriptor instead.
func (*ApplicationTable) Descriptor() ([]byte, []int) {
	return file_bpmetadata_ui_proto_rawDescGZIP(), []int{6}
}

func (x *ApplicationTable) GetRows() []*ApplicationTable_Row {
	if x != nil {
		return x.Rows
	}
	return nil
...
type ApplicationTable_Row struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Gen: manually-authored
	Label string `protobuf:"bytes,1,opt,name=label,proto3" json:"label" yaml:"label"` // @gotags: json:"label" yaml:"label"
	// Row value.
	// Required. Accepts string expressions. UTF-8 text. HTML
	// <code>&lt;a href&gt;</code> tags only. At most 128 characters.
	// Gen: manually-authored
	Value string `protobuf:"bytes,2,opt,name=value,proto3" json:"value" yaml:"value"` // @gotags: json:"value" yaml:"value"
	// If present, this expresssion determines whether the row is shown.
	// Boolean expression.
	// Gen: manually-authored
	ShowIf string `protobuf:"bytes,3,opt,name=show_if,json=showIf,proto3" json:"showIf,omitempty" yaml:"showIf,omitempty"` // @gotags: json:"showIf,omitempty" yaml:"showIf,omitempty"
}

func (x *ApplicationTable_Row) Reset() {
	*x = ApplicationTable_Row{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bpmetadata_ui_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ApplicationTable_Row) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApplicationTable_Row) ProtoMessage() {}

func (x *ApplicationTable_Row) ProtoReflect() protoreflect.Message {
	mi := &file_bpmetadata_ui_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApplicationTable_Row.ProtoReflect.Descriptor instead.
func (*ApplicationTable_Row) Descriptor() ([]byte, []int) {
	return file_bpmetadata_ui_proto_rawDescGZIP(), []int{6, 0}
}

func (x *ApplicationTable_Row) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *ApplicationTable_Row) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *ApplicationTable_Row) GetShowIf() string {
	if x != nil {
		return x.ShowIf
	}
	return ""
...
var file_bpmetadata_ui_proto_rawDesc = []byte{
	...
	0x61, 0x5f, 0x75, 0x69, 0x5f, 0x65, 0x78, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81,
	0x03, 0x0a, 0x10, 0x42, 0x6c, 0x75, 0x65, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x55, 0x49, 0x49, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x73, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x53,
	0x0a, 0x0e, 0x62, 0x6f, 0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x62, 0x70, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x52, 0x0d, 0x62, 0x6f, 0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x47, 0x72, 0x6f,
	0x75, 0x70, 0x73, 0x1a, 0x6d, 0x0a, 0x0e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73,
	...
	0x38, 0x01, 0x22, 0xae, 0x05, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x56, 0x61,
	...
	,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x61, 0x62, 0x65,
	0x6c, 0x52, 0x0f, 0x65, 0x6e, 0x75, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x61, 0x62, 0x65,
	0x6c, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x12, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x23, 0x0a, 0x0d, 0x62, 0x6f, 0x6f, 0x6c,
	0x65, 0x61, 0x6e, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0c, 0x62, 0x6f, 0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4a, 0x04, 0x08,
	0x13, 0x10, 0x14, 0x22, 0x38, 0x0a, 0x0a, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4c, 0x61, 0x62, 0x65,
	...
	0x74, 0x65, 0x78, 0x74, 0x22, 0xb9, 0x03, 0x0a, 0x11, 0x42, 0x6c, 0x75, 0x65, 0x70, 0x72, 0x69,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x5d, 0x0a, 0x11, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63,
	...
	0x74, 0x61, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61,
	0x62, 0x6c, 0x65, 0x52, 0x10, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x61, 0x62, 0x6c, 0x65, 0x1a, 0x69, 0x0a, 0x0c, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	...
	0x22, 0xa8, 0x01, 0x0a, 0x10, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x48, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x01, 0x20,
	...
	0x54, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x52, 0x6f, 0x77, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x1a,
	0x4a, 0x0a, 0x03, 0x52, 0x6f, 0x77, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x69, 0x66, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x68, 0x6f, 0x77, 0x49, 0x66, 0x22, 0x7d, 0x0a, 0x0c, 0x55,
	0x49, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x18, 0x0a, 0x07, 0x68,
	...
	,
...
var file_bpmetadata_ui_proto_goTypes = []interface{}{
	...
	(*ValueLabel)(nil),              // 2: google.cloud.config.bpmetadata.ValueLabel
	(*DisplaySection)(nil),          // 3: google.cloud.config.bpmetadata.DisplaySection
	(*BooleanGroup)(nil),            // 4: google.cloud.config.bpmetadata.BooleanGroup
	(*BlueprintUIOutput)(nil),       // 5: google.cloud.config.bpmetadata.BlueprintUIOutput
	(*ApplicationTable)(nil),        // 6: google.cloud.config.bpmetadata.ApplicationTable
	(*UIActionItem)(nil),            // 7: google.cloud.config.bpmetadata.UIActionItem
	(*DisplayOutput)(nil),           // 8: google.cloud.config.bpmetadata.DisplayOutput
	nil,                             // 9: google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry
	nil,                             // 10: google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry
	(*ApplicationTable_Row)(nil),    // 11: google.cloud.config.bpmetadata.ApplicationTable.Row
	(*GooglePropertyExtension)(nil), // 12: google.cloud.config.bpmetadata.GooglePropertyExtension
}
var file_bpmetadata_ui_proto_depIdxs = []int32{
	9,  // 0: google.cloud.config.bpmetadata.BlueprintUIInput.variables:type_name -> google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry
	3,  // 1: google.cloud.config.bpmetadata.BlueprintUIInput.sections:type_name -> google.cloud.config.bpmetadata.DisplaySection
	4,  // 2: google.cloud.config.bpmetadata.BlueprintUIInput.boolean_groups:type_name -> google.cloud.config.bpmetadata.BooleanGroup
	12, // 3: google.cloud.config.bpmetadata.DisplayVariable.x_google_property:type_name -> google.cloud.config.bpmetadata.GooglePropertyExtension
	2,  // 4: google.cloud.config.bpmetadata.DisplayVariable.enum_value_labels:type_name -> google.cloud.config.bpmetadata.ValueLabel
	7,  // 5: google.cloud.config.bpmetadata.BlueprintUIOutput.suggested_actions:type_name -> google.cloud.config.bpmetadata.UIActionItem
	10, // 6: google.cloud.config.bpmetadata.BlueprintUIOutput.outputs:type_name -> google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry
	6,  // 7: google.cloud.config.bpmetadata.BlueprintUIOutput.application_table:type_name -> google.cloud.config.bpmetadata.ApplicationTable
	11, // 8: google.cloud.config.bpmetadata.ApplicationTable.rows:type_name -> google.cloud.config.bpmetadata.ApplicationTable.Row
	1,  // 9: google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry.value:type_name -> google.cloud.config.bpmetadata.DisplayVariable
	8,  // 10: google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry.value:type_name -> google.cloud.config.bpmetadata.DisplayOutput
...
func file_bpmetadata_ui_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bpmetadata_ui_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApplicationTable_Row); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
