...
var file_bpmetadata_ui_proto_rawDesc = []byte{
	...
	0x22, 0x7e, 0x0a, 0x0d, 0x44, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4f, 0x75, 0x74, 0x70, 0x75,
...
var file_bpmetadata_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_bpmetadata_ui_proto_goTypes = []interface{}{
	...
	(*UIActionItem)(nil),            // 6: google.cloud.config.bpmetadata.UIActionItem
	(*DisplayOutput)(nil),           // 7: google.cloud.config.bpmetadata.DisplayOutput
	nil,                             // 8: google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry
	nil,                             // 9: google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry
	(*GooglePropertyExtension)(nil), // 10: google.cloud.config.bpmetadata.GooglePropertyExtension
}
var file_bpmetadata_ui_proto_depIdxs = []int32{
	8,  // 0: google.cloud.config.bpmetadata.BlueprintUIInput.variables:type_name -> google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry
	...
	10, // 3: google.cloud.config.bpmetadata.DisplayVariable.x_google_property:type_name -> google.cloud.config.bpmetadata.GooglePropertyExtension
	2,  // 4: google.cloud.config.bpmetadata.DisplayVariable.enum_value_labels:type_name -> google.cloud.config.bpmetadata.ValueLabel
	6,  // 5: google.cloud.config.bpmetadata.BlueprintUIOutput.suggested_actions:type_name -> google.cloud.config.bpmetadata.UIActionItem
	9,  // 6: google.cloud.config.bpmetadata.BlueprintUIOutput.outputs:type_name -> google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry
	1,  // 7: google.cloud.config.bpmetadata.BlueprintUIInput.VariablesEntry.value:type_name -> google.cloud.config.bpmetadata.DisplayVariable
	7,  // 8: google.cloud.config.bpmetadata.BlueprintUIOutput.OutputsEntry.value:type_name -> google.cloud.config.bpmetadata.DisplayOutput
